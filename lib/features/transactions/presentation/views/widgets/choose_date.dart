...
class _ChooseDateState extends State<ChooseDate> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AddUpdateTransactionCubit, AddUpdateTransactionState>(
      builder: (context, state) {
        if (!_initialized && state is UpdateTransactionInitial) {
          focusedDay = state.transaction.date!;
          today = state.transaction.date!;
          _initialized = true;
        }
        return Container(
